...
* **Ingest**: `raw/starter-reading.md` — created paper stubs and teaching [claims](claims/rna-is-incomplete-readout.md).
* **Ingest**: `raw/karpathy-llm-wiki.md` — created [llm-wiki](methods/llm-wiki.md) and [okf-v0.2](methods/okf-v0.2.md).
* **Ingest**: `raw/papers/2205.01187v1.pdf` — stub only, [GeoTyper](papers/wolfe-2022-geotyper.md). PDF not yet read.

## [2026-09-24] ingest | RESEARCH bootstrap
